	...
	<div class="text-left">	
		...
		<div></div>
			<form class="form-horizontal" action="https://www.sandbox.paypal.com/cgi-bin/webscr" method="POST">
				<input type='hidden' name='business' value='jaynesjumpers@gmail.com'>
				...
				<input type='hidden' name='notify_url' value='http://jaynesjumpers.co.uk/notify.php'>
				<input type='hidden' name='return' value='http://jaynesjumpers.co.uk/success.php'>
				<input type="hidden" name="cmd" value="_xclick">
				<input type="hidden" name="order" value="<?php echo $_SESSION["orderNumber"]; ?>">
				<br>
				<div class="form-group">
				<div class="col-sm-2">
				<input type="submit" class="btn btn-lg btn-block btn-success" name="continue_payment" value="Pay Now">
				</div>
				</div>
			</form>
	</div>
