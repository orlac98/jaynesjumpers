...
<script type="text/javascript" src="script/cart.js"></script>
 ...
 <section class="product-page">
  ...
  <div class="products-container">
            ...
            <?php			
			$sql_query = "SELECT product_name, product_desc, product_code, product_image, product_price FROM shop_products where product_code = (1)";	
        ...
        <div class="row">
            <div class="col-lg-3 col-sm-6">
                <div class="single-product-item">
                    <figure>
                        <a href="purplejumper.php"><img src="img/purplejumper.jpg" alt=""></a>
            ...
            <div class="col-lg-3 col-sm-6">
                <div class="single-product-item">
                    <figure>
                        <a href="blanket3.php"><img src="img/blanket3.jpg" alt=""></a>
                        <div class="p-status sale">Sale</div>
                    </figure>
                    <div class="product-text">
                        <h6>Knitted blanket</h6>
                        <p>€20</p>
                    </div>
                </div>
            </div>
